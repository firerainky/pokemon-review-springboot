...
public class ReviewControllerTests {
    ...
    @Test
    public void PokemonController_GetReviewsByPokemonId_ReturnsReviewDto() throws Exception {
        int pokemonId = 1;
    ...
    @Test
    public void PokemonController_GetReviewById_ReturnsReviewDto() throws Exception {
        int pokemonId = 1;
        int reviewId = 1;
    ...
    @Test
    public void PokemonController_DeleteReview_ReturnsOk() throws Exception {
        int pokemonId = 1;
        int reviewId = 1;
